...
//       if (shift > sliderMobile.current.clientWidth / 3) {
//         // enough to jump to next slide
//         console.log("stopOnMoveForwad");
//         for (let i = 0; i < sliderMobile.current.childNodes.length; i++) {
//           if (sliderMobile.current.childNodes[i].classList.contains("current")) {
...
//                 } else {
//                   sliderMobile.current.childNodes[0].style.left = ``;
//                   sliderMobile.current.childNodes[0].classList.add("current");
//                 }
//                 setShift(0);
...
//                 if (sliderMobile.current.childNodes[i + 1] !== undefined) {
//                   sliderMobile.current.childNodes[i + 1].style.left = ``;
//                   sliderMobile.current.childNodes[i + 1].style.display = `none`;
//                 } else {
//                   sliderMobile.current.childNodes[0].style.left = ``;
//                   sliderMobile.current.childNodes[0].style.display = `none`;
//                 }
//                 setShift(0);
//                 sliderMobile.current.style.pointerEvents = 'auto';
//               }
...
//       if (shift < -Math.abs(sliderMobile.current.clientWidth / 3)) {
//         // enough to jump to previous slide
//         console.log("stopOnMoveBackward");
//         for (let i = 0; i < sliderMobile.current.childNodes.length; i++) {
//           if (sliderMobile.current.childNodes[i].classList.contains("current")) {
...
//                   sliderMobile.current.childNodes[i - 1].classList.add("current");
//                 } else {
//                   sliderMobile.current.childNodes[sliderMobile.current.childNodes.length - 1].style.right = ``;
...
//                 } else {
//                   sliderMobile.current.childNodes[sliderMobile.current.childNodes.length - 1].style.right = ``;
//                   sliderMobile.current.childNodes[sliderMobile.current.childNodes.length - 1].style.display = `none`;
//                 }
//                 setShift(0);
//                 sliderMobile.current.style.pointerEvents = 'auto';
//               }
