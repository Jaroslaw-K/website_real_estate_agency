...
//   useEffect(() => { // RESPONSIBLE FOR SHOWING OR HIDING OPTIONS OF FORM FIELD WHEN USER PICK IT
...
//   const showOptionsHandler = (event) => { // RESPONSIBLE FOR STATE MANAGEMENT OF SHOWING OR HIDING OPTIONS OF FORM FIELD
